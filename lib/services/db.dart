  ...
  Future<Database> get database async {
    ...
    _db = await openDatabase(
      ...
      onUpgrade: (db, oldV, newV) async {
        ...
        if (oldV < 3) {
          try { await db.execute("ALTER TABLE sales RENAME COLUMN customerId TO customer_id"); } catch (_) {}
          try { await db.execute("ALTER TABLE sales RENAME COLUMN createdAt TO created_at"); } catch (_) {}
        }
      },
    );
    return _db!;
