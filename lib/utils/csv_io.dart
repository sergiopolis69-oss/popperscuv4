...
class CsvIO {
  ...
  static Future<String> _saveCsvBytes(String csv, String filename) async {
    ...
    // Intentamos API nueva; si no existe, caemos a la API vieja; si falla, guardamos en Documentos.
    try {
      ...
      final res = await FileSaver.instance.saveAs(
        ...
        // ext es reconocido por versiones recientes; si no, el catch de abajo manejará
        ext: 'csv',
      );
      return res;
    } catch (_) {
